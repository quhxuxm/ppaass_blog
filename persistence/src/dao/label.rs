use sea_orm::{ActiveModelTrait, ColumnTrait, ConnectionTrait, DatabaseConnection, EntityTrait, QueryFilter, TransactionTrait, TryIntoModel};
use sea_orm::ActiveValue::Set;
use ppaass_blog_domain::entity::{LabelActiveModel, LabelColumn, LabelEntity};
use crate::error::DaoError;
pub async fn save_label<C: ConnectionTrait +  TransactionTrait>(database: &C, text: String) -> Result<u32, DaoError> {
